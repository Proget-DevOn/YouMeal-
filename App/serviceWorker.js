...
const BASE_CACHE_FILES = [
  '/App/css/main.css',
  '/App/manifest.json',
  'App/ressources/logo_youmeal.png',
];

const OFFLINE_CACHE_FILES = [
  '/main.css',
  'App/layouts/offline/index.html',
];

const NOT_FOUND_CACHE_FILES = [
  '/App/css/main.css',
  '/App/layouts/offline/404.html',
];

const OFFLINE_PAGE =   'App/layouts/offline/index.html';
const NOT_FOUND_PAGE =   '/App/layouts/offline/404.html';
