...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <div class="row justify-content-center">
      <div class="col-6 col-md-4 text-center">
        ...
        <input type="text" class="form-control mt-4 contour_rose"  name="image" readonly placeholder="image" value= <?php echo $images?>>

          <div class="mt-4">
            <h1>
              Info recette
            </h1>
            <input type="text"class="form-control mt-4 contour_rose"  name="auteur" readonly value= <?php echo $_SESSION['login']?>>
            <input type="text" class="form-control mt-4 contour_rose"  name="nom_recette" id="nom_recette" placeholder="nom de la recette" required/>
            <label for="cout-select">Temps de réalisation:</label>
            <input type="time" class="form-control mt-1 contour_rose" name="temps_execution" id="temps_execution"placeholder="temps d'execution" required/>
          ...
          <div id="inserer_ing" class="mt-4">
            <h2>
              Ingredients
            </h2>
            <input type="number" class="form-control mt-4 contour_rose" name="quantite"  id="1" placeholder="15" required/>
            <input type="text" class="form-control mt-4 contour_rose" name="ingredient"  id="1" placeholder="ingredient1" required/>
          </div>

          <div id="inserer_etp" class="mt-4">
            <h2 class="form--header-title">
              Etape de la recette
            </h2>
            <textarea class="form-control mt-4 contour_rose" name="etape"  id="1" placeholder="etape 1" required/></textarea>
          </div>
  ...
  function ajout_ingredient(){
    ...
    ingredient.setAttribute("class","form-control mt-4 contour_rose");
  ...
  let etape= document.createElement("textarea");
    ...
    etape.setAttribute("class","form-control mt-4 contour_rose");
